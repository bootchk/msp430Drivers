...
#include "../src/alarmClock/epochClock/epochClock.h"
 ...
 *
 * Also test that time can be retrieved more than once per waking period, and time is monotonic.
 * Should see two pulses of power (using I2C bus) per waking period:
 *
